	...
	public MenuUsuario() {
		...
		btnBuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				btnBuscar.setBackground(SuperCorRGB);	
			}
			@Override
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/icone hotel rlr 3.png")));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				btnRegistro.setBackground(SuperCorRGB);	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
