...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/imagenes/hotel novo.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/imagenes/icone hotel rlr.png")));
		logo.setBounds(25, 15, 148, 159);
		panel.add(logo);
