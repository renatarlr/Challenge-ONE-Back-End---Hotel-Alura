...
public class MenuPrincipal extends JFrame {
	...
	*/
	...
	public MenuPrincipal() {
		...
		logo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/LOGO RENATA pequeno.png")));
		panel.add(logo);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(0, 500, 910, 37);
		panel_1.setBackground(new Color(28,33,125));
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblCopyR = new JLabel("Desenvolvido por RLR © 2023");
